 ...
 */
@Component
@StateHandler(machineId = ShopConstant.MACHINE_ID,state = ShopConstant.State.WAIT_PAY,event = ShopConstant.Event.START_PAY,sceneId = "WxPay")
public class StartWxPayProcessor implements StateProcessor<OrderPayContext> {

    @Override
    public String action(OrderPayContext context) {

        System.out.println("do weixin pay");
        return null;
    }
}
